			...
			<div class="main">
				...
				<div class="bot_table_wrapper">
					...
					<table class="tg">
						...
						<tr>
							<td class="tg-031e"><b>Firmware Version:</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['frmw_ver']; ?></td>
						</tr>
						<tr>
							<td class="tg-031e"><b>Content on SD-card:</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['sd_content']; ?></td>
						</tr>
					</table>
					<table class="tg">
						<tr>
							<th colspan="2" class="tg-031e"><h3>Build Stats</h3></th>
						</tr>
						<tr>
							<td class="tg-031e"><b>Last Buldname:</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['last_buildname']; ?></td>
						</tr>
						<tr>
							<td class="tg-031e"><b>Build Time:</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['BuildHours']."h ".$mbot_stats['BuildMinutes']."m"; ?></td>
						</tr>
						<tr>
							<td class="tg-031e"><b>Nozzel Temp/(Target):</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['tool0_temp']."&deg;C ( ".$mbot_stats['tool0_target_temp']."&deg;C )"; ?></td>
						</tr>
						<tr>
							<td class="tg-031e"><b>Toolhead state:</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['tool0_ready']; ?></td>
						</tr>
						<tr>
							<td class="tg-031e"><b>BuildState:</b></td>
							<td class="tg-031e"><?php echo $mbot_stats['BuildState']; ?></td>
						</tr>
					</table>
					<br><br><br>
